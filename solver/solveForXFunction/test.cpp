...
class mothercore{
  ...
  void create (char *filename){
    ...
    file.close();
    cout << "Core created from file." << endl;
    /*
...
void solveforx(mothercore core) {
  ...
  */
  ...
  vector<double> bxsm (bx, bx + sizeof(bx)/sizeof(bx[0]));
	vector<double> bysm (by, by + sizeof(by)/sizeof(by[0]));
